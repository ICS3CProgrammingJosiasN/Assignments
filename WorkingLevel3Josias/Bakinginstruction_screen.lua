...
-- Naming Scene
sceneName = "BakingInstruction_screen"
...
function scene:create( event )
    ...
    bkg_image = display.newImageRect("Images/BakingInstructionsScreenLoganS@2x-Recovered.png", display.contentWidth, display.contentHeight)
